...
async def login_page(request: Request):
    return templates.TemplateResponse("login.py", {"request": request, "error": None})
...
async def login(request: Request, username: str = Form(...), password: str = Form(...)):
    ...
    if user and user["password"] == password:
        ...
        return templates.TemplateResponse("login.py", {
            "request": request,
...
async def upload(request: Request):
    ...
    return templates.TemplateResponse("upload.html", {"request": request, "username": request.session.get("user"), "role": request.session.get("role")   })
